...
// Ìîäóëü RP2C02_LITE
module RP2C02_LITE(
    input Clk,               // Ñèñòåìíûé êëîê
    input Clk2,	             // Êëîê 21.477/ 26,601 äëÿ äåëèòåëÿ
    // Âõîäû
    input MODE,              // Ðåæèì PAL/NTSC
	input DENDY,             // Ðåæèì DENDY
	input nRES,              // Ñèãíàë ñáðîñà
	input PALSEL0,           // Âûáîð ïàëèòðû
	input PALSEL1,           // Âûáîð ïàëèòðû
    input RnW,               // Âíåøíèé ïèí ×òåíèå/Çàïèñü	
    input nDBE,              // Ñòðîá îáðàùåíèÿ ê PPU
	input [2:0]A,            // Àäðåñ ðåãèñòðà
	input [7:0]PD,           // Âõîä øèíû ãðàôè÷åñêèõ äàííûõ PPU
	// Âûõîäû
	inout [7:0]DB,           // Âíåøíÿÿ øèíà äàííûõ CPU
	output [17:0]RGB,        // Âûõîä RGB 6 + 6 + 6
	output [2:0]EMPH,        // EMPHASIS R G B
	output [13:0]PAD,        // Âûõîä àäðåñîâ øèíû PPU
	output INT,              // Âûõîä çàïðîñà ïðåðûâàíèÿ NMI
	output ALE,              // ALE âûõîä ñòðîáà çàùåëêèâàíèÿ ìëàäøåãî áàéòà àäðåñà VRAM
	output nWR,              // Ñòðîá çàïèñè VRAM	
	output nRD,              // Ñòðîá ÷òåíèÿ VRAM
	output SYNC,             // Âûõîä êîìïîçèòíîé ñèíõðîíèçàöèè
	output HSYNC,            // Âûõîä ñòðî÷íîé ñèíõðîíèçàöèè
    output VSYNC,            // Âûõîä êàäðîâîé ñèíõðîíèçàöèè
	output [7:0]DBIN,        // Âíóòðåííÿÿ øèíà äàííûõ CPU
	output DB_PAR            // Ïðîáðîñ äàííûõ CPU íà øèíó PPU
);
// Ñâÿçè ìîäóëåé
wire PCLK;
wire nPCLK;
...
//Ãëàâíûé ãåíåðàòîð òàéìèíãîâ PPU
...
// Óïðàâëåíèå ëîêàëüíîé øèíîé PPU
...
//Ïîèñê ñïðàéòîâ, ïîäëåæàùèõ âûâîäó íà äàííîé ñòðîêå
...
// Êîíåö ìîäóëÿ RP2C02_LITE
endmodule

//===============================================================================================
// Ìîäóëü âûáîðà ðåãèñòðà
//===============================================================================================
module REGISTER_SELECT(
input Clk,				       // Ñèñòåìíûé êëîê
// Âõîäû
input [7:0]DB,			       // Âõîäíûå äàííûå èç CPU
input nDBE,				       // Ñòðîá îáðàùåíèÿ ê PPU
input RnW,				       // Íàïðàâëåíèå îáðàùåíèÿ R/W
input [2:0]A,		           // Àäðåñ ðåãèñòðà
// Âûõîäû
output reg [7:0]DBIN,		   // Äàííûå âíåøíåé øèíû äàííûõ CPU
output R_EN,                   // Óïðàâëåíèå òðèñòýéòîì øèíû äàííûõ CPU
output reg W0,				   // Çàïèñü â  ðåãèñòð  #0
output reg W1,				   // Çàïèñü â  ðåãèñòð  #1
output reg R2,				   // ×òåíèå èç ðåãèñòðà #2
output reg W3,				   // Çàïèñü â  ðåãèñòð  #3
output reg W4,				   // Çàïèñü â  ðåãèñòð  #4
output reg R4,				   // ×òåíèå èç ðåãèñòðà #4
output reg W5_1,			   // Çàïèñü â  ðåãèñòð  #5/1
output reg W5_2,			   // Çàïèñü â  ðåãèñòð  #5/2
output reg W6_1,			   // Çàïèñü â  ðåãèñòð  #6/1
output reg W6_2,			   // Çàïèñü â  ðåãèñòð  #6/2
output reg W7,				   // Çàïèñü â  ðåãèñòð  #7
output reg R7				   // ×òåíèå èç ðåãèñòðà #7
);
// Ïåðåìåííûå
reg [2:0]ADR;
reg RnWR;
...
//===============================================================================================
// Ìîäóëü ñèñòåìíûõ ðåãèñòðîâ
//===============================================================================================
module REG2000_2001(
input Clk,				    // Ñèñòåìíûé êëîê
input nPCLK,				// Ïèêñåëüêëîê 
// Âõîäû
input W0,					// Çàïèñü â ðåãèñòð 0
input W1,					// Çàïèñü â ðåãèñòð 1
input RC,                   // Î÷èñòêà ðåãèñòðîâ
input [7:0]DBIN,			// Øèíà äàííûõ CPU
input nVIS,			        // Âèäèìàÿ ÷àñòü ñòðîêè
input CLIP_O,               // Ãàøåíèå ëåâîãî ñòîëáöà èç 8ìè òî÷åê ýêðàíà äëÿ ñïðàéòîâ
input CLIP_B,               // Ãàøåíèå ëåâîãî ñòîëáöà èç 8ìè òî÷åê ýêðàíà äëÿ ôîíà
// Âûõîäû
output reg I1_32,			// Èíêðåìåíò àäðåñà PPU +1/+32
output reg OBSEL,			// Ñòàðøèé áèò àäðåñà çíàêîãåíåðàòîðà ñïðàéòîâ
output reg BGSEL,			// Ñòàðøèé áèò àäðåñà çíàêîãåíåðàòîðà ôîíà
output reg O8_16,			// Âûñîòà ñïðàéòîâ (0 - 8 òî÷åê, 1 - 16 òî÷åê)
output VBL_EN,		        // Ðàçðåøåíèå ïðåðûâàíèÿ VBlank
output B_W,			        // Ðåæèì ×/Á (îáíóëåíèå ìëàäøèõ 4õ áèòîâ èíäåêñà öâåòà)
output reg BGCLIP,	        // Ãàøåíèå ëåâîãî ñòîëáöà 8 òî÷åê ó ôîíà
output reg OBCLIP,	        // Ãàøåíèå ëåâîãî ñòîëáöà 8 òî÷åê ó ñïðàéòîâ
output BLACK,               // Îòêëþ÷åíèå ðåíäåðà
output nCLPB,			    // Îòêëþ÷åíèå ôîíà
output CLPO,			    // Îòêëþ÷åíèå ñïðàéòîâ 
output [2:0]EMPH		    // Ýìïôàçèñ B,G,R
);
// Ïåðåìåííûå
reg [4:0]W0R;
reg [7:0]W1R;
...
// Êîíåö ìîäóëÿ ñèñòåìíûõ ðåãèñòðîâ
endmodule

//===============================================================================================
// Ìîäóëü ìóëüòèïëåêñîðà øèíû ïðè ÷òåíèè
//===============================================================================================
module READBUSMUX(
input Clk,				    // Ñèñòåìíûé êëîê
input PCLK,				    // Ïèêñåëüêëîê
// Âõîäû
input R_EN,                 // Óïðàâëåíèå òðèñòýéòîì øèíû äàííûõ CPU
input R4,					// Âûáîð R4
input [7:0]OB,			    // Øèíà äàííûõ ñïðàéòîâîé ìàøèíû
input RPIX,				    // Âûáîð ïèêñåëüíîãî âûâîäà
input [5:0]PIX,			    // Äàííûå ïèêñåëüíîãî âûâîäà
input R2,					// Âûáîð ÷òåíèÿ R2
input [2:0]R2DB,			// Äàííûå R2
input XRB,				    // Âûáîð ÷òåíèÿ VRAM
input PD_RB,				// Ñòðîá ìîñòà øèíû VRAM
input RC,                   // Î÷èñòêà ðåãèñòðîâ
input [7:0]DBIN,			// Øèíà äàííûõ CPU
input [7:0]PD,			    // Øèíà ãðàôè÷åñêèõ äàííûõ PPU
// Âûõîäû
output [7:0]DB	            // Âûõîä äàííûõ äëÿ ÷òåíèÿ PPU ñî ñòîðîíû CPU 
);
// Ïåðåìåííûå
reg [7:0]PD_R;
reg [7:0]OB_R;
...
assign DB[7:0] = R_EN ? D[7:0] : 8'hZZ; // òðèñòýéò äëÿ ðåæèìà ÷òåíèÿ
// Ëîãèêà
always @(posedge Clk) begin
...
//===============================================================================================
// Ìîäóëü ãëàâíîãî ãåíåðàòîðà òàéìèíãîâ PPU
//===============================================================================================
...
input nPCLK,         // Ïèêñåëüêëîê
// Âõîäû
input MODE,          // Ðåæèì PAL
input DENDY,         // Ðåæèì DENDY	
input OBCLIP,        // Îáðåçàíèå ëåâîé ÷àñòè ýêðàíà ñïðàéòîâ
input BGCLIP,        // Îáðåçàíèå ëåâîé ÷àñòè ýêðàíà ôîíà
input BLACK,         // Îòêëþ÷åíèå ðåíäåðà
input	VBL_EN,	     // Ðàçðåøåíèå çàïðîñà ïðåðûâàíèÿ VBlank
input R2,            // ×òåíèå ðåãèñòðà #2002
input nRES,          // Îáùèé ñáðîñ PPU
// Âûõîäû
output Hn0,          // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
output nHn2,         // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
output nHn1,         // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
output reg[5:0]Hnn,  // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
output reg S_EV,     // Çàïóñê ïðîöåññà ïðîñìîòðà ñïèñêà ñïðàéòîâ
output CLIP_O,       // Ãàøåíèå ëåâîãî ñòîëáöà èç 8ìè òî÷åê ýêðàíà äëÿ ñïðàéòîâ
output CLIP_B,       // Ãàøåíèå ëåâîãî ñòîëáöà èç 8ìè òî÷åê ýêðàíà äëÿ ôîíà
output reg O_HPOS,   // Çàïóñê ñ÷åò÷èêîâ êîîðäèíàòû X ñïðàéòîâ (ïîçèöèÿ 0 ñïðàéòîâ)
output reg nEVAL,    // Ñáðîñ ñ÷åò÷èêà OAM2 è íà÷àëî ïðîöåññà îáðàáîòêè OAM2
output reg E_EV,     // Îêîí÷àíèå ïðîöåññà ïðîñìîòðà ñïèñêà è ñðàâíåíèÿ ñïðàéòîâ
output reg I_OAM2,   // Ñèãíàë èíèöèàëèçàöèè (î÷èñòêè) OAM2
output reg PAR_O,    // Âû÷èòûâàíèå ãðàôèêè ñïðàéòîâ
output reg nVIS,     // Âèäèìàÿ ÷àñòü ñòðîêè
output reg nF_NT,    // ×òåíèå íîìåðà òàéëà èç Name Table
output F_TB,         // Ôàçà âûáîðêè âòîðîãî áàéòà òàéëà
output F_TA,         // Ôàçà âûáîðêè ïåðâîãî áàéòà òàéëà
output N_FO,         // Ñèãíàë ðàçðåøåíèÿ âûâîäà ãðàôèêè ôîíà
output F_AT,         // Ôàçà âûáîðêè àòðèáóòîâ èç Name Table
output BURST,        // Ìàñêà âûâîäà âñïûøêè ñèíõðîíèçàöèè ïîäíåñóùåé öâåòà
output SC_CNT,       // Çàïóñê ñ÷åò÷èêà àäðåñîâ ïðè âêëþ÷åíèè ðàñòðà è/èëè ôîíà
output SYNC,         // Âûõîä êîìïîçèòíîé ñèíõðîíèçàöèè
output reg HSYNC,    // Âûõîä ñòðî÷íîé ñèíõðîíèçàöèè
output reg VSYNC,    // Âûõîä êàäðîâîé ñèíõðîíèçàöèè
output nPICTURE,     // Ãàøåíèå
output reg RC,       // Î÷èñòêà ðåãèñòðîâ PPU
output reg RESCL,    // Ñòðîêà ïðåðåíäåðà (ñáðîñ âñåõ ñõåì âûáîðêè)
output BLNK,         // Ðåíäåð îòêëþ÷åí
output INT,          // Ïðåðûâàíèå ïî VBLANK
output reg R2DB7,    // ×òåíèå ôëàãà NMI
output [7:0]Vo       // Âûõîä âåðòèêàëüíîãî ñ÷åò÷èêà (äëÿ ñïðàéòîâîé ìàøèíû)
);
// Ïåðåìåííûå
reg [8:0]H;
reg [8:0]V;
...
always @(posedge Clk) begin
         ...
         VSET1    <= V_LINE3N | VLINE291 | VLINE241; // Àêòèâàöèÿ î÷åðåäè äëÿ ïðåðûâàíèÿ
	     VSET3    <= ~VSET2;
		          end          
                      end							
// Êîíåö ìîäóëÿ ãëàâíîãî ãåíåðàòîðà òàéìèíãîâ PPU
endmodule

//===============================================================================================
// Ìîäóëü óïðàâëåíèÿ ëîêàëüíîé øèíîé PPU
//===============================================================================================
...
input nPCLK,        // Ïèêñåëüêëîê
// Âõîäû
input R7,			// ×òåíèå èç ðåãèñòðà 7
input W7,			// Çàïèñü â  ðåãèñòð  7
input Hnn0,		    // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input Hn0,		    // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU 
input BLNK,		    // Ðåíäåð îòêëþ÷åí
input [13:8]PAD,	// Ñòàðøèå àäðåñà øèíû PPU
// Âûõîäû
output TSTEP,		// Èíêðåìåíò ñ÷åò÷èêîâ àäðåñà PPU
output PD_RB,		// Äàííûå â çàùåëêó ÷òåíèÿ øèíû PD
output DB_PAR,		// Ïðîáðîñ äàííûõ CPU íà øèíó PPU
output ALE,			// Ñèãíàë ALE
output nWR,			// Àêòèâàöèÿ çàïèñè
output nRD,			// Àêòèâàöèÿ ÷òåíèÿ
output XRB,			// Äàííûå íà øèíó CPU
output TH_MUX		// Îáðàùåíèå â ïàëèòðó
);
// Ïåðåìåííûå
reg W7_FF, R7_FF;
...
// Êîíåö ìîäóëÿ óïðàâëåíèÿ ëîêàëüíîé øèíîé PPU
endmodule

//===============================================================================================
// Ìîäóëü ãåíåðàòîðà ïèêñåëåé ôîíà
//===============================================================================================
module BG_COLOR(
input Clk,			// Ñèñòåìíûé êëîê 
input  PCLK,	    // Ïèêñåëüêëîê
...
// Âõîäû
input Hnn0,		    // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input nCLPB,		// Ôîí îòêëþ÷¸í
input F_TA,			// Ôàçà âûáîðêè ïåðâîãî áàéòà òàéëà
input F_AT,		    // Ôàçà âûáîðêè àòðèáóòîâ
input F_TB,			// Ôàçà âûáîðêè âòîðîãî áàéòà òàéëà
input N_FO,			// Àêòèâàöèÿ ñäâèãà ãðàôèêè
input [7:0]PD,		// Øèíà ãðàôè÷åñêèõ äàííûõ PPU
input THO1,			// Ãîðèçîíòàëüíàÿ êîîðäèíàòà â àòðèáóòå
input TVO1,			// Âåðòèêàëüíàÿ êîîðäèíàòà â àòðèáóòå
input [2:0]DBIN,	// Øèíà äàííûõ CPU
input W5_1,			// Çàïèñü â ðåãèñòð òî÷íîé ãîðèçîíòàëüíîé ïðîêðóòêè
input RC,			// Î÷èñòêà ðåãèñòðîâ
// Âûõîäû
output [3:0]BGC     // Âûõîä ïèêñåëåé ôîíà
);
// Ïåðåìåííûå
reg [3:0]BGC1;      
reg [3:0]BGC2;
...
assign BGC_POS[3:0] = (~FH[0] & ~FH[1] & ~FH[2]) ? {SR3[7], SR2[7], SR1[7], SR0[7]} :
					  ...
					  ( FH[0] &  FH[1] &  FH[2]) ? {SR3[0], SR2[0], SR1[0], SR0[0]} :
							                                                4'b0000 ;
// Ñäâèãîâûå ðåãèñòðû ïèêñåëåé ôîíà
wire QTA, QTB;
...
// Êîíåö ìîäóëÿ ãåíåðàòîðà ïèêñåëåé ôîíà
endmodule

//===============================================================================================
// Ìîäóëü ãåíåðàòîðà àäðåñà PPU
//===============================================================================================
module PAR_GEN(
input	Clk,			// Ñèñòåìíûé êëîê 
input	PCLK,	        // Ïèêñåëüêëîê
...
// Âõîäû
input	Hnn0,		    // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input	nF_NT,		    // ×òåíèå íîìåðà òàéëà èç Name Table
input	RC,			    // Î÷èñòêà ðåãèñòðîâ
input	PAR_O,		    // ×òåíèå ãðàôèêè ñïðàéòîâ
input	SH2,			// Ôàçà ÷òåíèÿ àòðèáóòà ñïðàéòà
input	[3:0]OV,		// Íîìåð ñòðîêè ãðàôèêè ñïðàéòà
input	[7:0]OB,		// Øèíà äàííûõ ñïðàéòîâîé ìàøèíû
input	[7:0]PD,		// Øèíà ãðàôè÷åñêèõ äàííûõ PPU
input	[7:0]DBIN,	    // Øèíà äàííûõ CPU
input	NHn1,		    // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input	O8_16,		    // Âûñîòà ñïðàéòà
input	OBSEL,		    // Ñòàðøèé áèò àäðåñà îáüåêòîâ
input	BGSEL,		    // Ñòàðøèé áèò àäðåñà ôîíà
input	RESCL,		    // Î÷èñòêà ôëàãîâ, çàãðóçêà äàííûõ â ñ÷åò÷èêè ñêðîëëèíãà
input	SC_CNT,		    // Çàïóñê ñ÷åò÷èêà àäðåñîâ ïðè âêëþ÷åíèè ðàñòðà è/èëè ôîíà
input	W0,			    // Çàïèñü â ðåãèñòð #0
input	W5_1,			// Çàïèñü â ðåãèñòð #5.1
input	W5_2,			// Çàïèñü â ðåãèñòð #5.2
input	W6_1,			// Çàïèñü â ðåãèñòð #6.1
input	W6_2,			// Çàïèñü â ðåãèñòð #6.2
input	F_AT,			// Ôàçà âûáîðêè àòðèáóòîâ
input	DB_PAR,		    // Ïðîáðîñ äàííûõ CPU íà øèíó PPU
input	E_EV,			// Îêîí÷àíèå ïðîöåññà ïðîñìîòðà ñïèñêà è ñðàâíåíèÿ ñïðàéòîâ
input	NHn2,		    // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input	TSTEP,		    // Èíêðåìåíò ñ÷åò÷èêîâ àäðåñà PPU
input	F_TB,			// Ôàçà âûáîðêè âòîðîãî áàéòà òàéëà
input	I1_32,		    // Èíêðåìåíò àäðåñà PPU +1/+32
input	BLNK,			// Ðåíäåð îòêëþ÷åí
// Âûõîäû
output reg [13:0]PAD,   // Âûõîä àäðåñà/äàííûõ VRAM
output [4:0]THO,	    // Âûõîä äàííûõ ïèêñåëÿ â ðó÷íîì ðåæèìå
output TVO1				// Âåðòèêàëüíàÿ êîîðäèíàòà â àòðèáóòå 
);
// Ïåðåìåííûå
reg TAL_LATCH;
reg VINV_LATCH;
...
// Êîíåö ìîäóëÿ ãåíåðàòîðà àäðåñà PPU
endmodule

//===============================================================================================
// Ìîäóëü ïîèñêà ñïðàéòîâ, ïîäëåæàùèõ âûâîäó íà äàííîé ñòðîêå
//===============================================================================================
module OBJ_EVAL(
input	Clk,		  // Ñèñòåìíûé êëîê 
input	PCLK,	      // Ïèêñåëüêëîê
input	nPCLK,        // Ïèêñåëüêëîê
// Âõîäû 		
input [7:0]V,         // Âûõîä âåðòèêàëüíîãî ñ÷åò÷èêà (äëÿ ñïðàéòîâîé ìàøèíû)
input [7:0]OB,		  // Øèíà äàííûõ ñïðàéòîâîé ìàøèíû
input O8_16,		  // Âûñîòà ñïðàéòà
input I_OAM2,		  // Ñèãíàë èíèöèàëèçàöèè (î÷èñòêè) OAM2
input nVIS,		      // Âèäèìàÿ ÷àñòü ñòðîêè
input SPR_OV,		  // Ñ÷åò÷èê ÎÀÌ ïåðåïîëíåí èëè íàéäåíî áîëëåå 8-ìè ñïðàéòîâ
input nF_NT,		  // ×òåíèå íîìåðà òàéëà èç Name Table
input Hnn0,		      // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input S_EV,		      // Çàïóñê ïðîöåññà ïðîñìîòðà ñïèñêà ñïðàéòîâ
input PAR_O,		  // ×òåíèå ãðàôèêè ñïðàéòîâ
// Âûõîäû
output [3:0]OV,	      // Íîìåð ñòðîêè ãðàôèêè ñïðàéòà 
output OMFG,		  // Ñèãíàë êîïèðîâàíèÿ òåêóùåãî ñïðàéòà ñðàâíåíèÿ â ÎÀÌ2
output reg PD_FIFO,   // Îáíóëåíèå ãðàôèêè ñïðàéòîâ
output reg SPR0_EV    // Ñïðàéò #0 íàõîäèòñÿ íà òåêóùåé ñòðîêå
);
// Ïåðåìåííûå
...
// Êîíåö ìîäóëÿ ïîèñêà ñïðàéòîâ, ïîäëåæàùèõ âûâîäó íà äàííîé ñòðîêå
endmodule

//===============================================================================================
// Ìîäóëü óïðàâëåíèÿ ïàìÿòüþ ñïðàéòîâ
//===============================================================================================
module OAM(
input	Clk,		  // Ñèñòåìíûé êëîê 
input  PCLK,	      // Ïèêñåëüêëîê
...
input BLNK,		      // Ðåíäåð îòêëþ÷åí
input nVIS,		      // Âèäèìàÿ ÷àñòü ñòðîêè
input W3,			  // Çàïèñü â ðåãèñòð àäðåñà OAM
input W4,			  // Çàïèñü â ðåãèñòð äàííûõ OAM
input I_OAM2,		  // Ñèãíàë èíèöèàëèçàöèè (î÷èñòêè) OAM2
input Hnn0,		      // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input nEVAL,		  // Ñáðîñ ñ÷åò÷èêà OAM2 è íà÷àëî ïðîöåññà îáðàáîòêè OAM2
input PAR_O,		  // ×òåíèå ãðàôèêè ñïðàéòîâ
input Hn0,		      // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU 
input NHn2,		      // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU	
input OMFG,		      // Ñèãíàë êîïèðîâàíèÿ òåêóùåãî ñïðàéòà ñðàâíåíèÿ â ÎÀÌ2
input RESCL,		  // Ñòðîêà ïðåðåíäåðà (ñáðîñ âñåõ ñõåì âûáîðêè)
input [7:0]DBIN,      // Øèíà äàííûõ CPU
// Âûõîäû
output reg [7:0]OB,   // Øèíà äàííûõ ñïðàéòîâîé ìàøèíû
output reg R2DB5,     // Ôëàã ïåðåïîëíåíèÿ ñïðàéòîâ
output reg SPR_OV     // Ñ÷åò÷èê ÎÀÌ ïåðåïîëíåí èëè íàéäåíî áîëëåå 8-ìè ñïðàéòîâ
);
// Ïåðåìåííûå
reg W4FF;
...
// Âëîæåííûå ìîäóëè ïàìÿòè
wire [7:0]OAMQ, OAM2Q; 
OAM_RAM  MOD_OAM_RAM  (OAM1ADR[7:0], Clk, DBIN[7:0], (WE & BLNK), OAMQ[7:0]);             // Ïàìÿòü OAM
OAM2_RAM MOD_OAM2_RAM (OAM2ADR[4:0], Clk, ( {8{ I_OAM2 }} | OB2[7:0] ), WE, OAM2Q[7:0]);  // Ïàìÿòü OAM2
// Ëîãèêà
always @(posedge Clk) begin
          if (~W4Q4) W4FF <= 1'b0;
...
// Êîíåö ìîäóëÿ óïðàâëåíèÿ ïàìÿòüþ ñïðàéòîâ
endmodule			

//===============================================================================================
// Ìîäóëü ñïðàéòîâîãî FIFO
//===============================================================================================
module OBJ_FIFO(
input	Clk,			  // Ñèñòåìíûé êëîê
input	PCLK,	        // Ïèêñåëüêëîê
input	nPCLK,        // Ïèêñåëüêëîê
// Âõîäû 		
input	[5:0]Hnn,	  // Ñèíõðîíèçèðîâàííîå àòîìàðíîå ñîñòîÿíèå PPU
input HPOS_0,       // Çàïóñê ñ÷åò÷èêîâ êîîðäèíàòû X ñïðàéòîâ (ïîçèöèÿ 0 ñïðàéòîâ)
input PAR_O,        // Âû÷èòûâàíèå ãðàôèêè ñïðàéòîâ
input CLPO,         // Ñïðàéòû îòêëþ÷åíû
input nVIS,         // Âèäèìàÿ ÷àñòü ñòðîêè
input PD_FIFO,      // Îáíóëåíèå ãðàôèêè ñïðàéòîâ
input [7:0]PD,      // Øèíà ãðàôè÷åñêèõ äàííûõ PPU
input [7:0]OB,      // Øèíà äàííûõ ñïðàéòîâîé ìàøèíû		     
// Âûõîäû 
output nSPR0HIT,    // Äåòåêòîð ñïðàéòà #0
output reg SH2,     // ×òåíèå àòðèáóòîâ ñïðàéòîâ (äëÿ ìèððîðèíãà ïî âåðòèêàëè)
output [4:0]ZCOL    // Âûõîä ñïðàéòîâîãî FIFO 
);
// Ïåðåìåííûå
reg [7:0]SEL_LATCH;
reg MIRR_LATCH;
...
// Ñ÷åò÷èêè ãîðèçîíòàëüíîé ïîçèöèè ñïðàéòîâîãî FIFO
wire [7:0]EN;   // Âûõîäû ñ÷åò÷èêîâ ãîðèçîíòàëüíîé ïîçèöèè ñïðàéòà
...
// Ñäâèãîâûå ðåãèñòðû ñïðàéòîâîãî FIFO
wire [7:0]SDATA;
...
// Êîíåö ìîäóëÿ ñïðàéòîâîãî FIFO
endmodule

//===============================================================================================
// Ìîäóëü ñ÷åò÷èêà ãîðèçîíòàëüíîé ïîçèöèè ñïðàéòîâîãî FIFO
//===============================================================================================
module FIFO_HPOSCNT(
input	Clk,		// Ñèñòåìíûé êëîê
input	PCLK,	    // Ïèêñåëüêëîê
input	nPCLK,      // Ïèêñåëüêëîê
// Âõîäû 
input [7:0]OB,      // Øèíà äàííûõ ñïðàéòîâ
input LOAD,         // Çàãðóçêà äàííûõ äëÿ ïåðåñ÷åòà
input nVIS,         // Âèäèìàÿ ÷àñòü ñòðîêè
input n0_H,         // Çàïóñê ñ÷åò÷èêîâ êîîðäèíàòû X ñïðàéòîâ (ïîçèöèÿ 0 ñïðàéòîâ)
// Âûõîäû 
output reg EN       // Óïðàâëåíèå òðèñòýéòîì âíåøíåé øèíû äàííûõ CPU
);
// Ïåðåìåííûå
reg ZH_FF;          // Òðèããåð óïðàâëåíèÿ îáðàòíûì ñ÷åò÷èêîì
reg [7:0]CNT;       // Çàùåëêè îáðàòíîãî ñ÷åò÷èêà
reg [7:0]CNT1;      // Çàùåëêè îáðàòíîãî ñ÷åò÷èêà
// Êîìáèíàòîðèêà
wire STEP;
...
// Êîíåö ìîäóëÿ ñ÷åò÷èêà ãîðèçîíòàëüíîé ïîçèöèè ñïðàéòîâîãî FIFO
endmodule

//===============================================================================================
// Ìîäóëü ñäâèãîâîãî ðåãèñòðà ñïðàéòîâîãî FIFO è BG_COLOR
//===============================================================================================
module SHIFTREG(
input	Clk,		// Ñèñòåìíûé êëîê
// Âõîäû 
input	NEXT,	    // Ðàçðåøåíèå íà ñäâèã, 2 ôàçà
input	STEP,       // Ðàçðåøåíèå íà ñäâèã, 1 ôàçà
input LOAD,         // Ðàçðåøåíèå íà çàãðóçêó äàííûõ äëÿ ñäâèãà
input [7:0]D,       // Äàííûå äëÿ ñäâèãà
// Âûõîäû 
output Q            // Âûõîä ñäâèãîâîãî ðåãèñòðà
);
// Ïåðåìåííûå
reg [7:0]QS;        // Âòîðàÿ ôàçà ñäâèãà
reg [7:0]QS_IN;     // Ïåðâàÿ ôàçà ñäâèãà
// Êîìáèíàòîðèêà
assign Q = QS[7];   // Âûõîä ñäâèãîâîãî ðåãèñòðà
// Ëîãèêà
always @(posedge Clk) begin
  if (LOAD | STEP) QS_IN[7:0] <= LOAD ? D[7:0] : {QS[6:0], 1'b0};
  if (NEXT) QS[7:0] <= QS_IN[7:0];
                      end
// Êîíåö ìîäóëÿ ñäâèãîâîãî ðåãèñòðà ñïðàéòîâîãî FIFO è BG_COLOR
endmodule
							 
//===============================================================================================
// Ìîäóëü ìóëüòèïëåêñîðà ïèêñåëåé
//===============================================================================================
module VID_MUX(
input	Clk,		 // Ñèñòåìíûé êëîê
input	PCLK,	     // Ïèêñåëüêëîê
...
input [4:0]THO,      //
input nVIS,			 // Âèäèìàÿ ÷àñòü ñòðîêè
input SPR0_EV,       // Ñïðàéò #0 íàõîäèòñÿ íà òåêóùåé ñòðîêå
input nSPR0HIT,	     // Äåòåêòîð ñïðàéòà #0
input RESCL,		 // Ñòðîêà ïðåðåíäåðà (ñáðîñ âñåõ ñõåì âûáîðêè)
input TH_MUX,		 // 
// Âûõîäû
output [4:0]CGA,     // Øèíà äàííûõ ãðàôèêè
output reg R2DB6     // Ôëàã ñïðàéòõèòà
);
// Ïåðåìåííûå
reg [4:0]ZCOLN;
reg [4:0]THO_LATCH;
...
// Êîíåö ìîäóëÿ ìóëüòèïëåêñîðà ïèêñåëåé
endmodule			
...
// Âõîäû
input R7,              // ×òåíèå èç ðåãèñòðà 7
input TH_MUX,		   // Îáðàùåíèå â ïàëèòðó
input nPICTURE,        // Ãàøåíèå
input B_W,             // Ðåæèì ×/Á (îáíóëåíèå ìëàäøèõ 4õ áèòîâ èíäåêñà öâåòà)
input DB_PAR,		   // Ïðîáðîñ äàííûõ CPU íà øèíó PPU
input [4:0]CGA,        // Øèíà äàííûõ ãðàôèêè 
input [5:0]DBIN,	   // Øèíà äàííûõ CPU
input PALSEL0,         // Âûáîð ïàëèòðû
input PALSEL1,         // Âûáîð ïàëèòðû

// Âûõîäû
output RPIX,           // Âûáîð ïèêñåëüíîãî âûâîäà
output reg [5:0]PIX,   // Äàííûå ïèêñåëüíîãî âûâîäà
output [17:0]RGB       // Âûõîä RGB 6 + 6 + 6
);
// Ïåðåìåííûå
reg DB_PARR;
...
// Âëîæåííûå ìîäóëè ïàëèòðîâîãî ÎÇÓ / ÏÇÓ
wire [17:0]RGB_IN;
wire [5:0]C;
...
// Âûõîä
assign RGB[17:0] = RGB_IN[17:0] & { 18 { ~PICTURER }};
// Ëîãèêà
always @(posedge Clk) begin
         if (PCLK) begin
			DB_PARR <= DB_PAR;
